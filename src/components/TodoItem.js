      ...
      <li className={this.isCompleted()}>
        ...
        <div className="buttons">
          <button onClick={this.props.delTodo.bind(this, id)}>
            <svg className="remove" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
              ...
              <path className="fill" d="M8,18c-0.4,0-0.6-0.3-0.6-0.6v-6.8C7.4,10.2,7.7,10,8,10c0.4,0,0.6,0.3,0.6,0.6v6.8C8.7,17.7,8.4,18,8,18z" />
          ...
          <button onClick={this.props.markComplete.bind(this, id)}>
            <svg className="complete" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
